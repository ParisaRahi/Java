...
public class Monitor2 {
    ...
    private int antallfilProdusenter;
    private int antallferdig = 0;
    private boolean erferdigProdusert = false;

    public Monitor2(SubsekvensRegister sr, int ant){
        subreg = sr;
        antallfilProdusenter = ant;
    }
    ...
    public void signalierFerdi(){
        laas.lock();
        try{
            antallferdig++;
            if(antallferdig == antallfilProdusenter){
                erferdigProdusert = true;
                System.out.println("Ferdig lest, antall hashmaper: " + subreg.stoerrelse());
            }
        }
        finally{
            laas.unlock();
